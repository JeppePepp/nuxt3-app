      ...
      >
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="#">
            ...
            <NuxtLink class="h-8 w-auto sm:h-10 block" to="/">
              <MainLogo />
            </NuxtLink>
            <!-- <img
          ...
          <Popover class="relative" v-slot="{ open }">
            ...
            >
              ...
              >
                ...
                >
                  <div
                    class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 z-50"
                  >
                    <NuxtLink
                      v-for="item in contacts"
                      :key="item.name"
                      :to="'/medarbetare/' + item.uid"
                      @click="() => (open = false)"
                    ...
                    >
                      ...
                      >
                        <prismic-image
                          class="transform scale-[2] rounded-full object-cover"
                          style="object-position: 0px 6px"
                          :field="item.data.image"
                        />
                      </div>

                      <div class="ml-4 h-12 flex items-center">
                        <prismic-rich-text
        ...
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
          <NuxtLink
            to="/kontakt"
            class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary hover:bg-indigo-700"
          >
            Kontakt
          </NuxtLink>
        </div>
